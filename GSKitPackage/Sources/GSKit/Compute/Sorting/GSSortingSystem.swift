...
final class GSSortingSystem: System {
    ...
    var depthParamsBuffers: [ObjectIdentifier: MTLBuffer] = [:]
    var radixPassParamsBuffers: [ObjectIdentifier: MTLBuffer] = [:]
    var scanParamsBuffers: [ObjectIdentifier: MTLBuffer] = [:]
    var writeParamsBuffers: [ObjectIdentifier: MTLBuffer] = [:]
